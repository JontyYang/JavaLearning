...
public class Q4_Solution3 {
    ...
    public static void main(String[] args) {
        int[] num1 = {}, num2 = {1, 2, 3, 4, 6, 9, 10};
        Q4_Solution3 solution3 = new Q4_Solution3();
        //寻找两个数组中位数
        System.out.println(solution3.findMedianSortedArrays(num1, num2));
        //寻找两个数组中第K小的数
        System.out.println(solution3.findKthElement(num1, num2, 2));
    }
